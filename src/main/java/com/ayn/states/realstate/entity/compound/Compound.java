...
public class Compound {
    ...
    @Formula("CONCAT('http://37.239.42.53:1800/realState/V1/api/CompoundAttachment/', cover_image_url)")
    ...
    // صورة مصغرة
    @Formula("CONCAT('http://37.239.42.53:1800/realState/V1/api/CompoundAttachment/', thumbnail_url)")
    ...
    // صورة ثلاثية الأبعاد
    @Formula("CONCAT('http://37.239.42.53:1800/realState/V1/api/CompoundAttachment/', model3d_url)")
