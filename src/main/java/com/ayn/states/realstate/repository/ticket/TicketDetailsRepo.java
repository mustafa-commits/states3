...
public interface TicketDetailsRepo extends JpaRepository<TicketDetails, Integer> {
    ...
    @Query("""
           ...
           WHEN td.messageType = MessageType.M4A THEN 'http://37.239.42.53:1800/realState/V1/api/stream-audio/' || tr.Content
           ELSE 'http://37.239.42.53:1800/realState/V1/api/downloadImg/' || tr.Content END ) from TicketDetails td
